...
<link rel="stylesheet" type="text/css" href="/resources/style/modifyform.css">
...
<body>
	...
	<main class="container">
		<section class="main-list">
			...
			<form class="write-form" action="modify" method="post">
				...
				<div class="button-group">
					<button class="w-btn w-btn-indigo" type="submit">수정 완료</button>
